<!--
auto-translated from src/content/blog/model-translategemma-27b-local-benchmark.md
target-locale: zh
...
本草稿旨在解决查询 "translategemma:27b local inference benchmark"，并应帮助读者今天做出具体的部署或扩展决策。
