<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-04-20.md
target-locale: zh
...
3.  如果故障率上升（OOM/重试次数激增），在横向扩展之前，请降低 quantization 等级或减少并发负载。

## 操作清单

-   在代表性提示长度下验证 tokens/s 和延迟。
-   按模型和 quantization 级别跟踪 OOM 和重试次数。
