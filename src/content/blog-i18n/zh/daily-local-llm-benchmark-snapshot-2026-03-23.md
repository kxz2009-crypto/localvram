<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-03-23.md
target-locale: zh
...
- `ministral-3:14b`: 89.3 tok/s | 延迟 2087 毫秒 | 测试 2026-03-15T12:17:40Z
- `qwen2.5:14b`: 84.9 tok/s | 延迟 975 毫秒 | 测试 2026-03-11T04:17:51Z

## 决策指南

1.  如果您的目标模型在 VRAM 中有足够的余量，优先考虑本地部署以获得可预测的延迟和更低的长期成本。
