<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-03-29.md
target-locale: zh
...
2. 如果 p95 延迟或吞吐量未达到生产目标，请将本地部署作为基线，仅在高峰期爆发式地转向云端。
3. 如果故障率上升（OOM/重试次数激增），在横向扩展之前，请降低量化等级或减少并发负载。
