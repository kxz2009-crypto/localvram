<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-07-01.md
target-locale: zh
...
-   **量化权衡**：较低的量化级别可以节省 VRAM，但在处理细微任务时可能会降低输出质量。

## 验证基准锚点

-   `gpt-oss:20b`: 156.1 tok/s | 延迟 1524 毫秒 | 测试 2026-04-29T05:39:58Z
-   `qwen2.5:14b`: 84.0 tok/s | 延迟 946 毫秒 | 测试 2026-04-29T05:39:58Z
-   `nemotron-3-nano:30b`: 57.0 tok/s | 延迟 2468 毫秒 | 测试 2026-04-01T11:53:50Z
-   `translategemma:27b`: 41.3 tok/s | 延迟 3142 毫秒 | 测试 2026-04-01T11:53:50Z
-   `qwen3-coder:30b`: 24.9 tok/s | 延迟 3724 毫秒 | 测试 2026-06-24T06:22:37Z
...
-   `qwen3.6:35b` 与 `gpt-oss:20b` — 相同大小级别，11 tok/s 对比 156 tok/s。
