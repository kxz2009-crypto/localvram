...
# Qwen3-Coder:30B Local Inference Benchmark: Practical Guide (2026)（中文整理中）
...
- 发布日期：2026-02-27
- 文章类型：性能基准
- 标签：ollama、qwen3、coder、30b、inference
- 英文原文：/en/blog/model-qwen3-coder-30b-local-benchmark/
