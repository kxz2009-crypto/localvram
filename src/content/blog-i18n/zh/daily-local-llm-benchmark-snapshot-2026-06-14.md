<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-06-14.md
target-locale: zh
...
`translategemma:27b` 在更高量化级别下接近 24GB 边界。如果您在 RTX 3090 上需要上下文余量，请考虑 Q4 或 Q5。在此 RTX 3090 上当前测量的模型中，其吞吐量排名**第 10 位（共 18 个）**。下一个更快的模型是 `nemotron-3-nano:30b` (57.0 tok/s，快 38%)。下一个更慢的模型是 `qwen3.6:35b` (41.1 tok/s，慢 0%)。
