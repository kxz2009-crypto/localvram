<!--
auto-translated from src/content/blog/model-nemotron-3-nano-30b-local-benchmark.md
target-locale: zh
...
本草稿旨在解决“nemotron-3-nano:30b 本地推理基准”这一查询，并应帮助读者今天做出具体的部署或扩展决策。
