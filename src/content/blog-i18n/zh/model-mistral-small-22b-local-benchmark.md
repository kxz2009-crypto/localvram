<!--
auto-translated from src/content/blog/model-mistral-small-22b-local-benchmark.md
target-locale: zh
...
本草案旨在解决查询 "mistral-small:22b local inference benchmark"，并应帮助读者今天做出具体的部署或扩展决策。
...
- 联盟披露: 本草案可能包含联盟链接。LocalVRAM 可能会在不产生额外费用的情况下赚取佣金。
- 将披露行放在 CTA 模块附近。
