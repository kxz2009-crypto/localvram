<!--
auto-translated from src/content/blog/daily-local-llm-benchmark-snapshot-2026-05-29.md
target-locale: zh
...
如果您想在24GB的RTX 3090上获得一个快速的本地基准，请首先下载`qwen3-coder:30b`。
...
1. 如果模型在VRAM中有余量且响应时间可接受，请先在本地运行。
2. 如果它能装下但未能达到p95延迟，请保留本地机器进行验证，并在高峰期突发到云端。
3. 如果出现OOM（内存不足），在购买硬件之前减少上下文或量化。
