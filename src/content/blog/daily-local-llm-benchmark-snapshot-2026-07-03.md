...
description: "Daily 3090 recommendation for mistral-small:22b: moderate performer at 62.2 tok/s, RTX 3090 benchmark data, use-case fit, and local-vs-cloud decision guide."
...
`mistral-small:22b` is a **moderate-speed** general-purpose model on a 24GB RTX 3090 (62.2 tok/s). It is worth testing locally for batch or offline workloads. For real-time interactive use, measure end-to-end latency with your typical prompt length before committing.

`mistral-small:22b` approaches the 24GB boundary at higher quantizations. Consider Q4 or Q5 if you need context headroom on the RTX 3090. It ranks **#7 of 18** in throughput among currently measured models on this RTX 3090. The next faster model is `deepseek-r1:14b` (81.2 tok/s, 31% faster). The next slower model is `nemotron-3-nano:30b` (57.0 tok/s, 9% slower).
...
- `mistral-small:22b` vs `qwen3-coder:30b` — same size tier, 62 vs 158 tok/s.
