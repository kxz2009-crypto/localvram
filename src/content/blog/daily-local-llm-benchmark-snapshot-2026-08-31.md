...
description: "Daily 3090 recommendation for mistral-small:22b: moderate performer at 50.9 tok/s, RTX 3090 benchmark data, use-case fit, and local-vs-cloud decision guide."
...
`mistral-small:22b` is a **moderate-speed** general-purpose model on a 24GB RTX 3090 (50.9 tok/s). It is worth testing locally for batch or offline workloads. For real-time interactive use, measure end-to-end latency with your typical prompt length before committing.

`mistral-small:22b` approaches the 24GB boundary at higher quantizations. Consider Q4 or Q5 if you need context headroom on the RTX 3090. It ranks **#8 of 18** in throughput among currently measured models on this RTX 3090. The next faster model is `nemotron-3-nano:30b` (57.0 tok/s, 12% faster). The next slower model is `translategemma:27b` (41.3 tok/s, 23% slower).
...
- **RTX 3090 speed:** 50.9 tok/s
- **Latency:** 2142 ms
- **Test time:** 2026-08-26T03:15:46Z
- **Baseline command:**
...
- `mistral-small:22b` vs `gpt-oss:20b` — same size tier, 51 vs 156 tok/s.
