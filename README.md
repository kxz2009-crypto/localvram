...
- `Runner Smoke Check` now uploads `logs/ollama-preflight-smoke.log`, and `Weekly Benchmark` records `logs/ollama-preflight-weekly.log` for direct preflight root-cause capture.
